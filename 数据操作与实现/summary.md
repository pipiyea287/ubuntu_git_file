...
it may act for the noise added in each batches. The noise generated in the process of calculating mean and standard deviation in each batch. And it can accelerate the speed of convergence without changing the accuracy of the model.
